...
urgent_red = temple
warning_orange = gnu_orange
element_yellow = gold
element_blue = sky
element_darkgreen = green_tea
element_lightgreen = moss
...
#--[ Completion ]--
c.colors.completion.category.bg = content_black
c.colors.completion.category.border.bottom = highlight_dark
c.colors.completion.category.border.top = content_black
c.colors.completion.category.fg = foreground

c.colors.completion.even.bg = content_black
c.colors.completion.odd.bg = content_black
c.colors.completion.fg = foreground

c.colors.completion.item.selected.bg = selected_color_bg
c.colors.completion.item.selected.border.bottom = selected_color_bg
c.colors.completion.item.selected.border.top = selected_color_bg
c.colors.completion.item.selected.fg = selected_color_fg
c.colors.completion.match.fg = urgent_red
c.colors.completion.scrollbar.bg = interface_black
c.colors.completion.scrollbar.fg = highlight_gray

## Background color for the download bar.
## Type: QssColor
c.colors.downloads.bar.bg = interface_black
c.colors.downloads.error.fg = foreground
c.colors.downloads.error.bg = urgent_red
c.colors.downloads.start.bg = element_blue
c.colors.downloads.start.fg = foreground
c.colors.downloads.stop.bg = element_darkgreen
...
## for transparency.
## Type: QssColor
c.colors.hints.bg = hint_color # eac58d
c.colors.hints.fg = interface_black
c.colors.hints.match.fg = urgent_red

## Background color of the keyhint widget.
## Type: QssColor
c.colors.keyhint.bg = 'rgba(0, 0, 0, 80%)'
c.colors.keyhint.fg = foreground
c.colors.keyhint.suffix.fg = element_yellow

## Background color of an error message.
## Type: QssColor
c.colors.messages.error.bg = urgent_red
c.colors.messages.error.border = urgent_red
c.colors.messages.error.fg = interface_black

## Background color of an info message.
## Type: QssColor
c.colors.messages.info.bg = interface_black
c.colors.messages.info.border = element_yellow
c.colors.messages.info.fg = foreground
c.colors.messages.warning.bg = warning_orange
c.colors.messages.warning.border = warning_orange
c.colors.messages.warning.fg = interface_black

## Background color for prompts.
## Type: QssColor
c.colors.prompts.bg = interface_black
c.colors.prompts.border = '1px solid ' + highlight_gray
c.colors.prompts.fg = foreground
c.colors.prompts.selected.bg = highlight_gray
...
c.colors.statusbar.command.bg = interface_black
c.colors.statusbar.command.fg = foreground
# c.colors.statusbar.command.private.bg = 'grey'
# c.colors.statusbar.command.private.fg = 'white'
c.colors.statusbar.insert.bg = element_darkgreen
c.colors.statusbar.insert.fg = foreground
c.colors.statusbar.normal.bg = interface_black
c.colors.statusbar.normal.fg = foreground
# c.colors.statusbar.private.bg = '#666666'
# c.colors.statusbar.private.fg = 'white'
c.colors.statusbar.progress.bg = highlight_gray
c.colors.statusbar.url.error.fg = warning_orange
c.colors.statusbar.url.fg = highlight_gray
c.colors.statusbar.url.hover.fg = element_lightaqua
c.colors.statusbar.url.success.http.fg = foreground
c.colors.statusbar.url.success.https.fg = element_lightgreen
...
iface_font_size = '9pt'
iface_font_type = ' monospace'

c.fonts.completion.category = 'bold ' + iface_font_size + iface_font_type
c.fonts.completion.entry = iface_font_size + iface_font_type
c.fonts.debug_console = iface_font_size + iface_font_type
c.fonts.downloads = iface_font_size + iface_font_type
c.fonts.keyhint = iface_font_size + iface_font_type
c.fonts.messages.error = iface_font_size + iface_font_type
c.fonts.messages.info = iface_font_size + iface_font_type
c.fonts.messages.warning = iface_font_size + iface_font_type
c.fonts.prompts = iface_font_size + ' sans-serif'
c.fonts.statusbar = iface_font_size + iface_font_type
c.fonts.tabs = iface_font_size + iface_font_type
